...
print(f"Evaluating on {len(questions)} fully-answerable questions...\n")
...
print("\n=== RESULTS ===")
print(f"Baseline  — avg precision: {average(baseline_p):.2f}, avg recall: {average(baseline_r):.2f}")
print(f"Re-ranked — avg precision: {average(reranked_p):.2f}, avg recall: {average(reranked_r):.2f}")